            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Pessoas Fisicas e Juridicas
                            Vinculadas</h3>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="last_name" class="block text-sm font-medium text-gray-700">Tipo de
                                            Vinculo</label>
                                        <input type="text" name="LinkType" id="last_name"
                                               class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full
                                           shadow-sm sm:text-sm border-gray-300 rounded-md"
                                               onkeypress="$(this).mask('R$ 999.990,00')" required>
                                    </div>
